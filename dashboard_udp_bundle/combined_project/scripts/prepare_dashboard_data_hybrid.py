...
RD_CENTER_PART_PATH = PROJECT_ROOT / "new" / "rd_center_daily_dashboard_data.json"
...
def _run_part(label: str, script: Path, cwd: Path, out_path: Path, *, include=None, exclude=None):
    env = os.environ.copy()
    ...
    merged["meta"].update(
        {
            ...
            "source_file": "data/source/muz.xlsx + new/\u0417\u0430\u044f\u0432\u043a\u0438+\u043e\u0431\u0440\u0430\u0449\u0435\u043d\u0438\u044f_\u043e\u0431\u044a\u0435\u0434\u0438\u043d\u0435\u043d\u043e.xlsx",
